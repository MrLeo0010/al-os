...
#define COL_BORDER_ACT    YELLOW    // Yellow - активная рамка
...
#define COL_PARENT        YELLOW    // Yellow - родительская папка
...
static void fm_view_file(void) {
    ...
    vga_clear();
    vga_print_color("=== Viewing: ", YELLOW);
